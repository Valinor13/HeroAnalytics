              ...
              <thead>
                <tr>
                  ...
                  {tableHeaders.map((header, index) => (
                    <th key={index} style={{ textAlign: 'center' }}>{header}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="textCenter">{`${Math.round(experience.logoA.gaze)}s`}</td>
                  <td className="textCenter">{`${Math.round(experience.logoA.proximity)}s`}</td>
                  <td className="textCenter">{`${Math.round(experience.logoA.touch)}s`}</td>
                ...
                <tr>
                  ...
                  <td className="textCenter">{`${Math.round(experience.logoB.gaze)}s`}</td>
                  <td className="textCenter">{`${Math.round(experience.logoB.proximity)}s`}</td>
                  <td className="textCenter">{`${Math.round(experience.logoB.touch)}s`}</td>
                  <td className="textCenter">
                    {experience.analyzed_sentiment === null
                      ? null
                      : experience.favoriteLogo === 'logoB'
                ...
                <tr>
                  ...
                  <td className="textCenter">{`${Math.round(experience.logoC.gaze)}s`}</td>
                  <td className="textCenter">{`${Math.round(experience.logoC.proximity)}s`}</td>
                  <td className="textCenter">{`${Math.round(experience.logoC.touch)}s`}</td>
                  <td className="textCenter">
                    {experience.analyzed_sentiment === null
                      ? null
                      : experience.favoriteLogo === 'logoC'
